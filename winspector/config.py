...
"""
 ...
 SECURITY WARNING: WinSpector sends alert data over plain HTTP with no
 authentication. This is only safe on an isolated, trusted network segment
 with xpack.security.enabled: false on the Elasticsearch side.
 Do NOT point this at an internet-reachable or shared-network Elasticsearch
 instance without enabling TLS and API-key authentication first.
...
"""
 ...
 Computed from this file's location — works regardless of where the repo is cloned. 
 Used in alert_scorer.py to suppress WinSpector's own process activity from being scored as suspicious.
"""
